package examples.crv15.logfire.benchmark1

import rete._
import java.util.ArrayList

// Same spec as benchmark2 and 3.
...
class M extends CSVMonitor {
  ...
  "r1" -- grant('t, 'r) & not(Granted('_, 'r)) |-> 
    insert(Granted('t, 'r))

  "r2" -- Granted('_, 'r) & grant('_, 'r) |-> 
    fail("bad grant")

  "r3" -- Granted('t, 'r) & release('t, 'r) |-> 
    remove(Granted)
  
  "r4" -- release('t, 'r) & not(Granted('t, 'r)) |-> 
    fail("bad release")
